...
export const LOCAL_DEV_SANDBOX_IMAGE_NAME = 'openbeard-sandbox';
export const SANDBOX_NETWORK_NAME = 'openbeard-sandbox';
export const SANDBOX_PROXY_NAME = 'openbeard-sandbox-proxy';
