...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  const base = options.interactive
    ? 'You are OpenBeard, an interactive CLI agent specializing in software engineering tasks.'
    : 'You are OpenBeard, an autonomous CLI agent specializing in software engineering tasks.';
